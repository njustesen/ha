...
public class TestSuite {
	...
	private static void rollingVsHistory(int runs, String size) {
		for(int budget = 10; budget <= 15000; budget = budget*5){
			...
			RollingHorizonEvolution history = new RollingHorizonEvolution(true, 100, .5, .75, budget, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.3), new HeuristicEvaluator(false)));
